        ...
        <div class="container">
            ...
            <div class="level">
                <div>
                    ...
                    <h2 class="subtitle">Kelola data guru</h2>
                </div>
                <div>
                    <a class="button is-link is-medium" href="/guru/tambah">
                ...
                <div class="field has-addons">
                    <div class="control is-expanded has-icons-left">
                        <input class="input is-rounded is-medium" type="text" name="search"
                               ...
                               placeholder="Cari nama, NIP, jurusan, atau mapel...">
            ...
            <p class="has-text-grey mb-4">
                Menampilkan <strong><?= count($guru) ?></strong> dari <strong><?= $totalData ?></strong> data guru.
            </p>
                        ...
                        <div class="column is-one-third">
                            <div class="card">
                                        ...
                                        <div class="media-left">
                                            <figure class="image is-48x48">
                                                <div class="is-flex is-align-items-center is-justify-content-center is-rounded has-background-link-light has-text-link" style="width: 48px; height: 48px;">
                                                    <span class="icon is-medium"><i class="fas fa-user-tie"></i></span>
                                                </div>
                                            </figure>
                                        </div>
                                        <div class="media-content">
                                            <p class="title is-5 mb-0"><?= htmlspecialchars($row['nama']) ?></p>
                                            <p class="subtitle is-6 has-text-grey">NIP: <?= htmlspecialchars($row['nip']) ?></p>
                                        </div>
                                    </div>

                                    <div class="content">
                                        <p class="mb-2">
                                            <span class="tag is-link is-light"><?= htmlspecialchars($row['nama_mapel']) ?></span>
                                ...
                                <footer class="card-footer">
                                    <a class="card-footer-item has-text-link" href="/guru/detail/<?= $row['id'] ?>" title="Lihat detail">
                                        <span class="icon mr-1"><i class="fas fa-eye"></i></span>Detail
                                    </a>
                                    <a class="card-footer-item has-text-link" href="/guru/edit/<?= $row['id'] ?>" title="Edit">
                                        <span class="icon mr-1"><i class="fas fa-pencil-alt"></i></span>Update
                                    </a>
                                    <a class="card-footer-item has-text-link" href="/guru/delete/<?= $row['id'] ?>"
                                       data-confirm="Data guru ini akan dihapus secara permanen." title="Hapus">
                ...
                <?php else: ?>
                    <div class="column is-full">
                        <div class="notification is-light">
                            Tidak ada data guru yang cocok dengan pencarian "<?= htmlspecialchars($keyword) ?>".
                        </div>
                    </div>
                <?php endif; ?>
